...
public class ProblemsService {
    ...
    @Autowired
    public ProblemsService(ProblemsRepo problemsRepo, CompanyProblemsRepo companyProblemsRepo) {
...
//        Sort sort = order.equalsIgnoreCase("asc") ? Sort.by(sortBy).ascending() : Sort.by(sortBy).descending();
        ...
        List<Problems> problems = companyProblemsRepo.findFilteredCompanyProblems(companyId, difficulty, minLookups, pageable).getContent();
        return convertToDTO(problems);
    }
}
